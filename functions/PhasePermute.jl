function PhasePermBetween(figs,WTof1,WTof2,Group1,Group2,curMeas,curStim,curLay,takepic=1)
    ...
    for iwt = 1:grpsize1
        thisGrp1[:,:,iwt] = WTof1[animals1[iwt]][curMeas[begin:end-2]][curMeas][curStim][curLay][2][:,1:1377]
    end
    ...
    for iwt = 1:grpsize2
        thisGrp2[:,:,iwt] = WTof2[animals2[iwt]][curMeas[begin:end-2]][curMeas][curStim][curLay][2][:,1:1377]
    end
    ...
    if takepic == 1
        ...
        differenceplots(figs, params, grp1_mean, grp2_mean, difmeans, clusters, Group1, Group2, curComp, curMeas,curStim,curLay,"phase")
        ...
        name = joinpath(figs,"Spectral",curComp) * "_" * curMeas * "_" * curStim * "_" * curLay * "_Phase_PermViolins.png"
